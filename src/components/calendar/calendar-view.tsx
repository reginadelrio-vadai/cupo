    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        <select
          ...
          className="h-9 rounded-md border border-[#E2E8F0] bg-white px-3 text-sm text-[#0F172A] focus:outline-none focus:ring-2 focus:ring-[#00B8E6]/20"
        >
